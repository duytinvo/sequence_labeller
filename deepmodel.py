...
from utils.core_nns import deepBiLSTM_CRF as fNN
...
if __name__ == '__main__':
    """
    CUDA_VISIBLE_DEVICES=1 screen python deepmodel.py --emb_file /media/data/embeddings/glove/glove.6B.100d.txt --word_dim 100 --word_hidden_dim 200 --char_dim 50 --char_hidden_dim 100 --dropout 0.5 --drop_final 0.5 --lr 0.015 --batch_size 10 --model_name d1.bilstm.m --model_args ./results/d1.bilstm.args.pkl --c_norm --w_norm
    """
    ...
    argparser.add_argument("--emb_file", type = str, default = "/media/data/embeddings/glove/glove.6B.100d.txt", help = "embedding file")
    ...
    argparser.add_argument('--model_name', help='Model dir', default="dbilstm.m", type=str)
    
    argparser.add_argument('--model_args', help='Model dir', default="./results/dbilstm.args.pklz", type=str)
